...
export const STAGES = Object.freeze([
  ...
  { stage:  2, name: '光',          emoji: '✨', threshold:     10 },
  { stage:  3, name: '物質',        emoji: '🪨', threshold:     25 },
  { stage:  4, name: '星',          emoji: '⭐', threshold:     50 },
  { stage:  5, name: '惑星',        emoji: '🌍', threshold:    100 },
  { stage:  6, name: '海',          emoji: '🌊', threshold:    200 },
  { stage:  7, name: '生命',        emoji: '🌱', threshold:    400 },
  { stage:  8, name: '動物',        emoji: '🦕', threshold:    800 },
  { stage:  9, name: '人類',        emoji: '👤', threshold:   1600 },
  { stage: 10, name: '文明',        emoji: '🏛️', threshold:   3200 },
  { stage: 11, name: '戦争',        emoji: '⚔️', threshold:   6400 },
  { stage: 12, name: '宇宙・銀河', emoji: '🌌', threshold:  12800 },
  { stage: 13, name: '多元宇宙',   emoji: '🔮', threshold:  25600 },
  { stage: 14, name: '神域',        emoji: '👁️', threshold:  51200 },
  { stage: 15, name: 'タポカリプス', emoji: '💥', threshold: 100000 },
]);
